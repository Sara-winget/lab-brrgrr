...
function renderPrice(){
  ...
  let onionsPrice  = 20
  let lettucePrice  = 20
  var price=basePrice+(state.Patty*pattyPrice)+(state.Cheese*cheesePrice)+(state.Tomatoes*tomatoesPrice)+(state.Onions*state.onionsPrice)+(state.Lettuce*lettucePrice);
